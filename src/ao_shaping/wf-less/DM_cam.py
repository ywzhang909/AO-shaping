...
if __name__ == "__main__":
    ...
    args.add_argument("-c", "--center", type=parse_tuple, default=(665, 403), help="远场光斑CCD中心位置 (default: (665, 403))")
    args.add_argument("--exposure_time_ms", type=int, default=100, help="远场光斑CCD曝光时间 (毫秒) (default: 60)")
