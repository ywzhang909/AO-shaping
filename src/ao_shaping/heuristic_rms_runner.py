...
from ao_shaping.optimizer.heuristic.rms_heuristic import optimizer_rms_heuristic
...
def run(dir, epochs, wfs_res, pupil_diameter, pupil_center, algorithm, early_stop_threshold, debug, show):
    """使用元启发式算法优化RMS"""
