...
if pf == "Windows":
    ...
    SLM_Ctrl_WriteMI_BMP_A.__doc__ = """SLM_Ctrl_WriteMI_BMP_A(DWORD SLMNumber, DWORD MemoryNumber, DWORD Flags, LPCSTR FileName)"""
...
SLM_Ctrl_ReadTD.__doc__ = """SLM_Ctrl_ReadTD(DWORD SLMNumber, float *deviceTemp)"""
...
SLM_Ctrl_ReadTO.__doc__ = """SLM_Ctrl_ReadTO(DWORD SLMNumber, float *optionTemp)"""
...
SLM_Ctrl_ReadED.__doc__ = """SLM_Ctrl_ReadED(DWORD SLMNumber, DWORD *deviceError)"""
...
SLM_Ctrl_ReadEO.__doc__ = """SLM_Ctrl_ReadEO(DWORD SLMNumber, DWORD *optionError)"""
...
SLM_Ctrl_ReadSD.__doc__ = """SLM_Ctrl_ReadSD(DWORD SLMNumber, LPSTR deviceID)"""
...
SLM_Ctrl_ReadSO.__doc__ = """SLM_Ctrl_ReadSO(DWORD SLMNumber, LPSTR optionID)"""
...
SLM_Ctrl_Reboot.__doc__ = """SLM_Ctrl_Reset(DWORD SLMNumber)"""
...
SLM_Ctrl_ReadPN.__doc__ = """SLM_Ctrl_ReadPN(DWORD SLMNumber, LPSTR DisplayProductID)"""
