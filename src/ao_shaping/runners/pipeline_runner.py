...
from ao_shaping.utils.cli_helpers import setup_coredumpy, get_date_dir_name, get_debug_mode
...
def run(dir, load_file, epochs, wf_epochs, wfs_res, pupil_diameter, cam_id, exposure_time_ms, cam_size, rms_threshold, dm_unit_mask, dm_type):
    """串行优化器（先波前优化，再轴向光束优化）
    ...
    try:
        ...
        ccd_records = optimize_pib(
            ...
            init_v=min_iter["_v"], show=False, dm=dm)
