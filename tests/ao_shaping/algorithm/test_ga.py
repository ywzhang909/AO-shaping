...
class TestGeneticAlgorithm:
    ...
    def test_optimize_sphere_function(self):
        ...
        params = GAParams(pop_size=20, n_generations=50, bounds=(-5, 5))
...
class TestMinimizeGA:
    ...
    def test_minimize_ga_basic(self):
        ...
        best_x, best_f = minimize_ga(
            fitness_fn=sphere, dim=3, pop_size=20, n_generations=30, bounds=(-5, 5)
        )
    ...
    def test_minimize_ga_with_early_stop(self):
        ...
        best_x, best_f = minimize_ga(
            fitness_fn=sphere, dim=2, n_generations=500, early_stop_threshold=0.05
        )
