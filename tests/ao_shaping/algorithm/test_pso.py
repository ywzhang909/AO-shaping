...
class TestPSOParams:
    ...
    def test_custom_params(self):
        ...
        params = PSOParams(
            n_particles=50, n_iterations=500, w=0.5, c1=1.5, c2=2.0, bounds=(-5, 5)
        )
...
class TestParticleSwarmOptimizer:
    ...
    def test_optimize_sphere_function(self):
        ...
        params = PSOParams(n_particles=20, n_iterations=50, bounds=(-5, 5))
...
class TestMinimizePSO:
    ...
    def test_minimize_pso_basic(self):
        ...
        best_x, best_f = minimize_pso(
            fitness_fn=sphere, dim=3, n_particles=20, n_iterations=30, bounds=(-5, 5)
        )
    ...
    def test_minimize_pso_with_early_stop(self):
        ...
        best_x, best_f = minimize_pso(
            fitness_fn=sphere, dim=2, n_iterations=500, early_stop_threshold=0.05
        )
...
class TestPSOStability:
    ...
    def test_deterministic_with_seed(self):
        ...
        pso1 = ParticleSwarmOptimizer(
            dim=3, params=params, random_state=np.random.default_rng(123)
        )
...
class TestPSOConvergence:
    ...
    def test_convergence_to_global_minimum(self):
        ...
        params = PSOParams(n_particles=50, n_iterations=200, bounds=(-10, 10))
        pso = ParticleSwarmOptimizer(dim=5, params=params)
