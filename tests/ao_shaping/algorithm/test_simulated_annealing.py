...
class TestSimulatedAnnealing:
    ...
    def test_optimize_sphere_function(self):
        ...
        params = SAParams(
            n_iterations=100, initial_temp=50.0, final_temp=0.01, bounds=(-5, 5)
        )
    ...
    def test_temperature_decreases(self):
        ...
        params = SAParams(
            n_iterations=100, schedule=TempSchedule.LINEAR, bounds=(-5, 5)
        )
        sa = SimulatedAnnealing(dim=2, params=params)
...
class TestNeighborGeneration:
    ...
    def test_neighbor_within_bounds(self):
        ...
        sa = SimulatedAnnealing(dim=3, params=SAParams(bounds=(-2, 2), step_size=1.0))
...
class TestMinimizeSA:
    ...
    def test_minimize_sa_basic(self):
        ...
        best_x, best_f = minimize_sa(
            fitness_fn=sphere, dim=3, n_iterations=100, bounds=(-5, 5)
        )
    ...
    def test_minimize_sa_with_early_stop(self):
        ...
        best_x, best_f = minimize_sa(
            fitness_fn=sphere, dim=2, n_iterations=500, early_stop_threshold=0.1
        )
